...
import java.util.*;
/*
public class PyRouter {
    static String lanOutFile = "lanX.txt";
    private static int selfDestructInMs = 120000;
    private static final int MAX = 10;
    private static final int igmpInMs = 20000;

    ArrayList<Integer> directAttachedLans = new ArrayList<>();
    ArrayList<Lan> allLans=new ArrayList<>();
    Dictionary<Integer,HashSet<>>
